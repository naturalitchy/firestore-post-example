...
import 'package:firestore_posts_example/firebase_options.dart';
import 'package:firestore_posts_example/root_screen.dart';
import 'package:flutter/material.dart';
/**
 *
 * use the "flutter pub upgrade --major-versions" in terminal
 *
 */
 ...
 *
 * 실험해볼것은
 * 1. DB 컬럼 클래스를 통해 CRUD 실행.
 * 2. 단일 int 또는 String 을 집어넣고 후에 추가(add)하면 List로 변하는지.
 * 3.
 *
 */
...
//     final bb = await db.collection("users").doc("zGoAwdYINvuAkCUhy3ji").get();
//     print(' >>> bb = ${bb}');
//   } catch(e) {
//     print(' ################ error = ${e}');
//   }
...
//
//   // try exception.
//   db.collection("users").doc("userkey1").update({
//     "age" : 50,
//     "name" : "modify",
//   });
// }
